...
def plot_skewt(data, x_y, timestep, airport, output_path, forecast_times, run_time):
    ...
    plt.figtext(0.83, 0.46, f"SBCIN: {sbcin.magnitude:.1f} J/kg", ha="center", va="top", fontsize=12, color='black')
    plt.figtext(0.83, 0.44, f"K Index: {k_index.magnitude:.1f}", ha="center", va="top", fontsize=12, color='black')
    plt.figtext(0.83, 0.42, f"Total Totals: {total_totals.magnitude:.1f}", ha="center", va="top", fontsize=12, color='black')
